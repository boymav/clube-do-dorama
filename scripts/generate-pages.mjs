...
for (const d of doramas) {
  ...
  // Recomendados: por tags (mais parecido), 12 itens
  const recs = (doramas || [])
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    @media (min-width: 860px){
      .hero-inner{padding:22px; grid-template-columns: 240px 1fr; gap:22px;}
      .poster{width:240px;}
      h1{font-size: 36px;}
      .desc{font-size: 15px;}
      .section{padding:20px;}
      .rec-card{flex-basis: 180px;}
...
console.log(`✅ OK: ${pages.length} páginas Netflix-style geradas`);
